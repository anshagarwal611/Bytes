...
const SignUp = () => {
  return (
    <div className='signup-container'>
        ...
        <p className=' text-sm mt-6 p-0 mb-10'>We have sent the verification code to<br/>
        ...
        <input id='phone-input' type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
        <input id='phone-input' type="text" className="custom-input block p-3 mr-1 mb-6 w-10 text-sm text-gray-900 rounded-full  border-1 border-gray-300 active:border-gray-300"  />
